(function (global) {
    ...
    var Player = function (game, x, y) {
        ...
        this.body.setSize(12, 30, -3, -1);
        this.body.bounce.y = 0.0;
        this.body.gravity.y = 600;
        this.body.collideWorldBounds = true;
        this.animations.add('walk', [1, 2,3 ], 10, true);
    ...
    Player.prototype.update = function () {
        ...
        if (this.body.x>1792&&!this.win){
            console.log ("win");
            this.win=true;
            this.game.add.tween(this.scale).to ( {x:0.1, y: 0.1}, 1000, "Linear", true) ;
        }
        if (this.win) { return };
        switch (this.mode) {
            case MODES.PLAY:
            ...
            if (this.cursors.left.isDown || gamepad.state.C) {
                ...
                if(spider){this.body.velocity.x = -110;
                }
                else{
